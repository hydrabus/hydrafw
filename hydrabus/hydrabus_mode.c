...
static bool hydrabus_mode_delay(t_hydra_console *con, const char* const* argv, int* nb_arg_car_used)
{
  ...
  {
    chprintf(chp, mode_str_delay_us, nb_repeat);
    DelayUs(nb_repeat);
  }
  else
  {
    chprintf(chp, mode_str_delay_ms, nb_repeat);
